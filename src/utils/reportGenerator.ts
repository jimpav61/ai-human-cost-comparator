 ...
 */
function ensureLeadHasValidId(lead: Lead): Lead {
 ...
 */
async function createOrGetReportsBucket(): Promise<void> {
  try {
    ...
    console.log("Setting public access policy for 'reports' bucket");
