...
export const DocumentGenerator = ({ lead }: DocumentGeneratorProps) => {
  ...
  const handleDownloadReport = async () => {
    try {
      ...
      // Check for existing report in the generated_reports table using ONLY the lead ID
      ...
      throw new Error("No report found for this lead ID. Please generate a report from the frontend first.");
